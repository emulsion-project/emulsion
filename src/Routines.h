...
void calcNearFieldPlane(const string &fname, const int &NT, const int &NP,const double &t1,const double &t2,const double &p1,const double &p2,const int &plane, const bool &cart);
void calcNearFieldParticleSurface(const string &fname, const int &NT, const int &NP, const bool &cart);
...
void calcEELSMapping(const string &fname, const int &NT, const int &NP,const double &t1,const double &t2,const double &p1,const double &p2);
