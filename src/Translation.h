...
public:
  Translation();
  Translation(const int &typ, const bool &dir, const int &n, const Complex kk, const double &xx, const double &yy, const double &zz);
  void setParameters(const int &typ, const bool &dir, const int &n, const Complex kk, const double &xx, const double &yy, const double &zz);
  void calcMatrix();
  void calcMatrixZ();
