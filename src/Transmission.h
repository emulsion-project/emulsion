...
public:
	Transmission();
	Transmission(const double &lambd, const int &n, const int &ng,
			const double &xx, const double &yy, const double &zzi,
			const double zzj, const bool &self);
	void setParameters(const double &lambd, const int &n, const int &ng,
			const double &xx, const double &yy, const double &zzi,
			const double zzj, const bool &self);
